...
const KinshipCard = ({ kinship }: IKinshipCardProps) => {
  ...
  return (
    <div
      className="kinship-card"
      data-select={state.register.kinship === kinship.title}
      onClick={handlerKinship}
    >
      {/* <figure>
      ...
      <div>
        ...
        <span className="text-mini block -mt-1 font-bold text-gray-tertiary">
          {kinship.subtitle}
        </span>
      </div>
    </div>
